...
function Feedback() {
  ...
  const { categories, currentQuestion, isTrailComplete } = useGame();
    ...
    <div className="min-h-screen bg-[#f3fde9] text-[#151e12] font-body flex flex-col items-center pb-32">
      <main className="flex-1 w-full max-w-md px-6 pt-24 pb-8 flex flex-col items-center justify-center space-y-6">
        ...
        <div className="text-center space-y-2 mb-8">
          <h2 className="font-headline text-[24px] leading-[32px] font-bold text-[#136e00]">
            Muito bem!
          </h2>
          <p className="font-body text-[18px] leading-[28px] font-medium text-[#3d4b37]">
            Você concluiu este desafio com sucesso.
          </p>
        </div>

        <div
          className="w-full bg-white rounded-xl p-6 border-2 border-[#58CC02] relative overflow-hidden group"
          style={{ boxShadow: "0 0 40px -5px rgba(88, 204, 2, 0.4)" }}
        >
          ...
          <div className="flex items-start gap-4 relative z-10">
            ...
            <div className="space-y-2">
              <h3 className="font-headline text-[16px] leading-[20px] font-bold text-[#58CC02] uppercase tracking-widest">
                Você sabia?
              </h3>
              <p className="font-body text-[16px] leading-[24px] text-[#151e12] leading-relaxed">
                {currentQuestion.feedback_acerto}
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="w-full pt-8 flex flex-col items-center gap-2">
          <div className="w-full h-1 bg-[#dce6d2] rounded-full overflow-hidden">
            <div
              className="h-full bg-[#58CC02] transition-all duration-[3000ms] ease-linear"
              style={{ width: `${progress}%` }}
            ></div>
          </div>
          <span className="text-[12px] font-headline font-bold text-[#3d4b37]/60 uppercase">
            Desbloqueando próxima categoria...
          </span>
        </div>
        ...
        <div className="w-full flex flex-col gap-4 mt-8">
          <button
            ...
            className="w-full h-12 bg-[#2bcc00] text-[#0b4f00] font-headline text-[16px] leading-[20px] font-bold tracking-wider uppercase rounded-xl flex items-center justify-center gap-2"
            style={{ boxShadow: "0 4px 0 0 #0b4f00" }}
          >
            Prosseguir
          ...
          <button
            ...
            className="w-full h-12 bg-white border-2 border-[#bccbb2] text-[#3d4b37] font-headline text-[16px] leading-[20px] font-bold tracking-wider uppercase rounded-xl flex items-center justify-center gap-2"
            style={{ boxShadow: "0 4px 0 0 #bccbb2" }}
          >
